...
const Contrata = () => {
  return (
      ...
      <section className={styles.container}>
        <Nav />
      <div className={`container ${styles.px6} ${styles.py8} ${styles.mxAuto}`}>
        <div
          className={`${styles.smFlex} ${styles.smItemsCenter} ${styles.smJustifyBetween}`}
        >
          <div>
            <h2
              className={`${styles.text3xl} ${styles.fontBold} ${styles.textGray800} ${styles.darkTextGray100}`}
            >
        ...
        >
          ...
          >
            ...
            >
              Para la mayoría de las empresas que desean optimizar las consultas
              web.
            </p>
